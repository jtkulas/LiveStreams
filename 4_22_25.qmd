...
author: "OOH Session #74...<br>...[University Syllabus]{.syllabus .bigger} via [typst...]{.honk2}<br> ...Part II: Tackling Tables"
title-slide-attributes: 
  data-background-image: https://images.fineartamerica.com/images-medium-large-5/1-1930s-1940s-man-teacher-professor-vintage-images.jpg  
...
-   Recap session #73
-   Focal issue(s):
    - [University Syllabus]{.syllabus .bigger}<br>via [typst...]{.honk2}<br> ...Part II: Tackling Tables
...
![](img/title73.JPG){.absolute top="135" right="-120" width="600" height="325"}
...
# Recap of Session <br>#73: 

![](https://pngimg.com/d/sticky_note_PNG18964.png){.absolute right="50" top="200"}

![](https://png.pngtree.com/png-vector/20230904/ourmid/pngtree-fail-stamp-grungy-png-image_9932568.png){.absolute width="275" top="270" right="100"}
...
![](https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExaTU4am0wcnhkZWR1MjkyM2NrOHd0YTMyZDFvb3I4MHQ3cmdkOTcxdSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3o7qDXpK3z7h4sUWfS/giphy.gif)
...
![](https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExZGpkbnpieWF1ejAxbWR5MHI1NWQwdWtlOGEzaWZqcnBjcGFsdWg3MCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/aSZSj0mT8f6tW/giphy.gif){.absolute right="40" bottom="120" height="500"}
