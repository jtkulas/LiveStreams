...
## `Plotly` `r fontawesome::fa("plug-circle-bolt", fill="#8ffcff")`[[Interactivity]{.electric}](https://quarto.org/docs/interactive/)`r fontawesome::fa("plug-circle-bolt", fill="#8ffcff")`
...
## Moar `r fontawesome::fa("plug-circle-bolt", fill="#8ffcff")`[[Interactivity]{.electric}](https://quarto.org/docs/interactive/)`r fontawesome::fa("plug-circle-bolt", fill="#8ffcff")`
