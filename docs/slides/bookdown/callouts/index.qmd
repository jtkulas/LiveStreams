...
author: "[OOH Session #39...<br>...introducing]{.titleauthor} [interactivity]{.electric}" 
...
#    output-location: slide           ## column-fragment; inserts blank 2nd slide
    ...
    theme: [weekly.scss, league]       ## night & league
    logo: "erg2.png"
...
## Open Office Hours <br>(August 20, 2024)
...
## `r fontawesome::fa("r-project", fill="#4287f5")` Session Info (August 20, 2024) Rendering:
