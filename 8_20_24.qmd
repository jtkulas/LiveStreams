...
::: {.column width="50%"}
::: {.callout-note}
None of the previous 4 visuals utilized `htmlwidgets` functions within this current slide presentation
:::
:::
::::

::: {.callout-caution}
The `threejs` object lost "spinnability" interactivity without `htmlwidgets` being explicitly utilized (online hosted slides versus locally rendered "client" slides) 
:::
