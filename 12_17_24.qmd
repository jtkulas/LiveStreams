...
![](https://www.freeiconspng.com/thumbs/rocket-png/red-rocket-png-5.png){.absolute width="250" right="110" top="270" .tilt}
...
# viola
```
1. Supabase has a "Table Editor" identifier. The name you choose here will appear on the Supabase site.
2. Allows the survey to be launched [without connecting to the database](https://surveydown.org/store-data#ignoring-the-supabase-connection). If responses are provided, they will be stored within a local `preview_data.csv` file (within your project directory).
...
::: {.bigger}
[...Conditional Logic]{.fragment .fade-in-then-semi-out fragment-index=1} 
<br>[...Response Images]{.fragment .fade-in-then-semi-out fragment-index=2}
<br>[...Theming]{.fragment .fade-in-then-semi-out fragment-index=3}
:::
:::
::::
