...
-   Focal issue(s):
    - [Slide navigation]{.navigation} `r emo::ji("compass")` 
...
2. Width Height. If ignore, will tile/fill
...
## `r emo::ji("compass")``r emo::ji("compass")` [Slide Navigation]{.navigation} `r emo::ji("compass")``r emo::ji("compass")`
