...
```
1. First encountered (topmost) format will render if using the R Studio IDE execution "buttons"

### Future Developments `r fontawesome::fa("github", fill="#FFFFFF")`

Link to GitHub page

[Changelog description](https://www.freecodecamp.org/news/a-beginners-guide-to-git-what-is-a-changelog-and-how-to-generate-it/)
