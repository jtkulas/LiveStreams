...
1. [Thesisdown](https://github.com/ismayc/thesisdown) vs. [.cls specification](https://tysonbarrett.com/jekyll/update/2018/02/11/r_dissertation/) `r emo::ji("boxing_glove")`
2. Updates:
