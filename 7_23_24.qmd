...
::: aside
Scaling (text/image) issues seem to be [operating system-related](https://forum.obsidian.md/t/mermaid-scaling-text-cufoff-or-overflowing/4594/36). <br>`Ctrl-0` followed by `ctrl-r` will reset screens in html browsers.
:::
